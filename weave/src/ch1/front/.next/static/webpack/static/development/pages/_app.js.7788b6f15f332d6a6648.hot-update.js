...
function loginAPI(loginData) {
  //서버에 요청을 보내는 부분
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/login', loginData);
}
...
function signUpAPI(signUpData) {
  //서버에 요청을 보내는 부분
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('http://localhost:3065/api/user/n', signUpData);
}
...
//# sourceMappingURL=_app.js.7788b6f15f332d6a6648.hot-update.js.map