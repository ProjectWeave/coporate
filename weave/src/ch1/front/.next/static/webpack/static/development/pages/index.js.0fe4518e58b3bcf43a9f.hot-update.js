...
const Login = () => {
  ...
  const dispatch = Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["useDispatch"])(); // const [ modevalue, setMode ] = useState({
  //   mode:'read'
  // }); //초기값
  ...
  if (undefined.state.mode === 'clicked') {
    return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_IndexPage__WEBPACK_IMPORTED_MODULE_7__["default"], {
      __source: {
  ...
  if (undefined.state.mode === 'read') return __jsx("div", {
    ...
    className: "btn",
    onClick: function (e) {
      this.props.onChangeMode('clicked');
    }.bind(undefined),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 74
...
//# sourceMappingURL=index.js.0fe4518e58b3bcf43a9f.hot-update.js.map