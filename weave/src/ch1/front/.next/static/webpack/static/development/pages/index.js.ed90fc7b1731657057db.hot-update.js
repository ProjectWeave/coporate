...
const IndexPage = () => {
  const {
    GroupPosts
  } = Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["useSelector"])(state => state.gpost.user);
  const {
    addedGroupPost
  ...
  return __jsx("div", {
    ...
    return __jsx(_GroupBox__WEBPACK_IMPORTED_MODULE_8__["default"], {
      key: c,
      gpost: c,
      __source: {
        fileName: _jsxFileName,
...
//# sourceMappingURL=index.js.ed90fc7b1731657057db.hot-update.js.map