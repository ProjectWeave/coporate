...
const ContentForm = ({
  ...
  if (postAdded === true) return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      __self: undefined
    }, post.Comments ? post.Comments.length + '댓글' : 0 + '댓글'), dummyComment.map(t => {
      return item => __jsx("li", {
        key: +post.createdAt,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 107
        ...
        __self: undefined
      }, item.User.nickname, item.User.nickname[0], " :", item.content, __jsx("button", {
        type: "button",
        className: "remove",
        value: "REMOVE",
        __source: {
...
//# sourceMappingURL=cont.js.811a447ee784e363e3bf.hot-update.js.map