...
/* harmony import */ var _Toggle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Toggle */ "./components/Toggle.js");
...
const Header = () => {
  ...
  return __jsx("div", {
    ...
    __self: undefined
  }), __jsx(_Toggle__WEBPACK_IMPORTED_MODULE_6__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 54
    },
...
// }
// const Hea = () => {
//   const [clickBtn, setClickBtn] = useState({on: false});
//   const handleClick =(e)=>{
//     e.preventDefault();
//     setClickBtn({on: !e.target.on});
//   };
//   const Toggle = (e) => { 
//       return(
//           <div className="toggleBox">
...
//# sourceMappingURL=_app.js.3b04a8d4c2db19368f33.hot-update.js.map