...
const AppLayout = ({
  ...
  const {
    setState
  } = Object(react_redux__WEBPACK_IMPORTED_MODULE_3__["useSelector"])(state => state.user); // if(!isLoggedIn)return<><Home /></>

  if (!isLoggedIn && Mode === 'read') return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_Home__WEBPACK_IMPORTED_MODULE_7__["default"], {
    __source: {
  ...
  __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(_Header__WEBPACK_IMPORTED_MODULE_5__["default"], {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 24
    },
    ...
    __self: undefined
  }, children)); // if(!isLoggedIn && Mode==='clicked')return<></>
...
//# sourceMappingURL=_app.js.3583702affbbd9840ccd.hot-update.js.map