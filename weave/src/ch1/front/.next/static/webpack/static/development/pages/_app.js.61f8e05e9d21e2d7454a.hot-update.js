...
const ContentForm = ({
  ...
  if (postAdded === true) return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      __self: undefined
    }), commentFormOpened === true && mainPosts.map(t => {
      return __jsx("li", {
        key: t.createdAt,
        __source: {
          fileName: _jsxFileName,
        ...
        __self: undefined
      }, t.User.nickname, t.User.nickname[0], " :", t.content, __jsx("button", {
        type: "button",
        className: "remove",
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=_app.js.61f8e05e9d21e2d7454a.hot-update.js.map