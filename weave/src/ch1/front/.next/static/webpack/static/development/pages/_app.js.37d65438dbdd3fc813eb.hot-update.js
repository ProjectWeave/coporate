...
const AppLayout = ({
  ...
  const {
    isLoggedIn
  } = Object(react_redux__WEBPACK_IMPORTED_MODULE_3__["useSelector"])(state => state.user); // if(isLoggedIn ==='true'){
  //     <IndexPage /> 
  // }   
  // if( !isLoggedIn ){
...
//# sourceMappingURL=_app.js.37d65438dbdd3fc813eb.hot-update.js.map