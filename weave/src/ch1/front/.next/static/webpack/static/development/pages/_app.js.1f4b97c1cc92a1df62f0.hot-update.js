...
const Cont = () => {
  ...
  const {
    0: comments,
    1: setComments
  } = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])('button');
  const {
    imagePaths,
    isAddingPost,
    postAdded,
  ...
  onInputComment = e => {
    e.preventDefault();
    console.log("코멘트");
    setComments("startcomment"); //document.querySelector(".comment").style.display="block";
  };
...
//# sourceMappingURL=_app.js.1f4b97c1cc92a1df62f0.hot-update.js.map